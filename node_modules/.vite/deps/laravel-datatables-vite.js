    ...
    (function(global, factory) {
      ...
      var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, init2 = jQuery7.fn.init = function(selector, context, root) {
        ...
        if (typeof selector === "string") {
          ...
          return root.ready !== void 0 ? root.ready(selector) : selector(jQuery7);
        }
          ...
          if (!rneedsContext.test(selectors)) {
            for (; i2 < l; i2++) {
              for (cur = this[i2]; cur && cur !== context; cur = cur.parentNode) {
                if (cur.nodeType < 11 && (targets ? targets.index(cur) > -1 : cur.nodeType === 1 && jQuery7.find.matchesSelector(cur, selectors))) {
                  matched.push(cur);
                  break;
                }
              }
      ...
      var isHiddenWithinTree = function(elem, el) {
        elem = el || elem;
        return elem.style.display === "none" || elem.style.display === "" && isAttached(elem) && jQuery7.css(elem, "display") === "none";
      };
      ...
      function getWidthOrHeight(elem, dimension, extra) {
        ...
        if ((!support.boxSizingReliable() && isBorderBox || !support.reliableTrDimensions() && nodeName(elem, "tr") || val === "auto" || !parseFloat(val) && jQuery7.css(elem, "display", false, styles) === "inline") && elem.getClientRects().length) {
      ...
      jQuery7.each(["height", "width"], function(_i, dimension) {
        jQuery7.cssHooks[dimension] = {
          get: function(elem, computed, extra) {
            if (computed) {
              return rdisplayswap.test(jQuery7.css(elem, "display")) && (!elem.getClientRects().length || !elem.getBoundingClientRect().width) ? swap(elem, cssShow, function() {
        ...
        valHooks: {
          option: {
            get: function(elem) {
              ...
              return val != null ? val : stripAndCollapse(jQuery7.text(elem));
            }
          },
          select: {
            get: function(elem) {
      ...
      jQuery7.extend({
        ...
        ajaxSetup: function(target, settings) {
          return settings ? ajaxExtend(ajaxExtend(target, jQuery7.ajaxSettings), settings) : ajaxExtend(jQuery7.ajaxSettings, target);
        },
      ...
      jQuery7.fn.load = function(url, params, callback) {
        ...
        if (self.length > 0) {
          jQuery7.ajax({
            ...
            response = arguments;
            self.html(selector ? jQuery7("<div>").append(jQuery7.parseHTML(responseText)).find(selector) : responseText);
        ...
        jQuery7.each({
          ...
          jQuery7.fn[funcName] = function(margin, value) {
            ...
            return access(this, function(elem, type2, value2) {
              ...
              return value2 === void 0 ? jQuery7.css(elem, type2, extra) : jQuery7.style(elem, type2, value2, extra);
